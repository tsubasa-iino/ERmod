...
module sysvars
   ...
   ! approximate functional: see also thnc_cutoff when functional = 'thnc'
   character(len=8) :: functional = 'pyhnc'

   character(len=3) :: invmtrx = 'reg'   ! matrix inversion: gce, reg, or evd
   character(len=4) :: zerosft = 'eczr'  ! reference origin of energy coordinate
   ...
   real :: thnc_cutoff = 0.0            ! active only when functional = 'thnc'
...
91       continue
      ...
      if(zerosft == 'orig') zerosft = 'eczr'    ! 'orig' deprecated
